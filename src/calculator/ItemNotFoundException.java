...
/**
 * {@link ItemNotFoundException} is a custom exception for when the user attempts to add a new item to the 
 * {@link Impact_Calculator} allItems {@code HashMap}.
 * <p>
 * This exception is only called by the {@link Impact_Calculator#checkItemList(String) checkItemList()} method.
 ...
 * @version 4/4/2025
 * @see Impact_Calculator Impact_Calculator
